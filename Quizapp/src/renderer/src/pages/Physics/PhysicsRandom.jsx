    ...
    if (!scoreSent) {
      socket.send(
        JSON.stringify({
          ...
          name: user.name,
          std: user.std,
          appName: 'Physics Public Pattern',
          totalq: quiz.length
        })
      )
    }
        ...
        <div className="quiz-box-container">
                ...
                {quiz[currentQuestion].options.map((option, i) => (
                  <li
                    ...
                    className={`option-item ${
                      quiz[currentQuestion].option_mode === 'image' ? 'option-itemX' : ''
                    } ${quiz[currentQuestion].option_mode === 'imagey' ? 'option-itemY' : ''}${
                      quiz[currentQuestion].option_mode === 'images' ? 'option-itemS' : ''
                    }${quiz[currentQuestion].option_mode === 'imagez' ? 'option-itemZ' : ''}
                  ...
                  >
                    <img
                      ...
                      alt="option"
                      className={`${
                        quiz[currentQuestion].option_mode === 'image' ? 'imageX' : ''
                      } ${quiz[currentQuestion].option_mode === 'imagey' ? 'imageY' : ''}${
                        quiz[currentQuestion].option_mode === 'images' ? 'imageS' : ''
                      }${quiz[currentQuestion].option_mode === 'imagez' ? 'imageZ' : ''}
                      `}
                    />
                  </li>
                ))}
          ...
          <div className="d_n-container">
            <div className="dashboard">
              <h1>Physics Public Pattern Test</h1>
              <span className="user_info">
                <span className="user-image-con">
