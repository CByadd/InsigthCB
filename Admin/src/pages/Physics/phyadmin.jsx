...
function Phyadmin() {
  ...
  return (
    <div className="maincontainer">
        ...
        <div className="custom-dropdown">
          ...
          {isDropdownOpen && (
            <ul className="dropdown-menu">
              <li onClick={() => changeOption("Physics-Public Pattern")}>Physics-Public Pattern</li>
              <li onClick={() => changeOption("Physics-volume-1")}>Volume-1</li>
              <li onClick={() => changeOption("Physics-volume-2")}>Volume-2</li>
              <li onClick={() => changeOption("Physics-Chapterwise")}>Chapterwise</li>
            </ul>
          )}
        </div>
      </div>
      ...
      {selectedOption === "Physics-Chapterwise" && (
        <div className="ChapSelectorSection">
          <section className="chapselectors">
            {["chapter-1", "chapter-2", "chapter-3", "chapter-4", "chapter-5", "chapter-6", "chapter-7", "chapter-8", "chapter-9", "chapter-10","chapter-11"].map((chapter) => (
              <button
                key={chapter}
